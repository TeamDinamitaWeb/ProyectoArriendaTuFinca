...
public class SolicitudService {
    ...
    public List<SolicitudDTO> obtenerPorArrendatario(Long idArrendatario) {
        List<SolicitudArriendo> solicitudes = solicitudRepository.findByArrendatarioId(idArrendatario);
